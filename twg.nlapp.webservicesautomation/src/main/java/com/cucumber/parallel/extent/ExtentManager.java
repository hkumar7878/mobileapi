package com.cucumber.parallel.extent;
import java.io.File;
...
public class ExtentManager {
	    ...
	    static String fileName="MobileAutomationReport.html";
	...
	public static void captureScreenshot() {
		i = i + 1;
		File scrFile = ((TakesScreenshot) NewBaseClass.getDriver()).getScreenshotAs(OutputType.FILE);
		Date d = new Date();
